...
namespace WindowsFormsApplication1
{
	public class Form1 : Form
	{
		...
		private void explodeMe(Rectangle area)
		{
			...
			int maxValue = junkie.Next(25) + 35;
			int maxValue2 = junkie.Next(25) + 35;
			int maxValue3 = junkie.Next(25) + 35;
			for (int i = 0; i < 50; i++)
			{
				if (gfx != null)
				{
					gfx.FillEllipse(new SolidBrush(Color.FromArgb(junkie.Next(40) + 40, junkie.Next(maxValue) + 195, junkie.Next(maxValue2) + 195, junkie.Next(maxValue3) + 195)), new Rectangle(junkie.Next(30) - junkie.Next(30) + num2, junkie.Next(30) - junkie.Next(30) + num3, junkie.Next(20) + num, junkie.Next(20) + num));
				}
			}
		}
	}
